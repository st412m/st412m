...
* 24 tools: system monitoring, WiFi analysis, client management, VPN status, Mesh topology, extender logs, backup scheduler
* Pure Python, no external dependencies — runs directly on the router via Entware
* Dynamic mesh extender discovery — logs and stats from all nodes automatically
* Tested on Keenetic Giga KN-1010/KN-1011, KeeneticOS 5.0.11
